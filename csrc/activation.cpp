...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("invoke_dequant_silu_and_mul_quant", &invoke_dequant_silu_and_mul_quant,
        "Dequant input, apply silu act and quant output");
  m.def("invoke_dequant_silu_and_mul", &invoke_dequant_silu_and_mul,
        "Dequant input, apply silu act");
}
